...
Процедура ОбработкаЗаполнения(Основание)
	...
	ИначеЕсли ТипЗнч(Основание)=Тип("ДокументСсылка.ПланируемоеПоступлениеДенежныхСредств") Тогда
		...
		СуммаДокумента=РасшифровкаПлатежа.Итог("СуммаПлатежа");
	ИначеЕСли ТипЗнч(Основание)=Тип("ДокументСсылка.новаОтчетВодителя") Тогда	
		//ОтчетВодителя = Основание.Ссылка;
		//СуммаДокумента = Основание.ПринятыеСуммы.Итог("СуммаФакт");
		//
		//
		//СтрокаПлатеж = РасшифровкаПлатежа.Добавить();
		//ВидОперации  = Перечисления.ВидыОперацийПКО.ОплатаПокупателя;
