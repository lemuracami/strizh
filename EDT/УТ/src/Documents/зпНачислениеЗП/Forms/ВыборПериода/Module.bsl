...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВыбиратьВидПериода = СвойствоСтруктуры(Параметры, "ВыбиратьВидПериода", Ложь);
	Если ВыбиратьВидПериода Тогда
		ВидыВыбираемыхПериодов = Новый ФиксированныйМассив(СвойствоСтруктуры(Параметры, "ВидыВыбираемыхПериодов"));
	КонецЕсли;
	...
	ЦветФонаКнопкиВыбранногоПериода = WebЦвета.СветлоЗеленый;
...
Процедура ОбновитьОтображение()
	...
	УстановитьЗаголовокКомандеГод(ЭтаФорма);
