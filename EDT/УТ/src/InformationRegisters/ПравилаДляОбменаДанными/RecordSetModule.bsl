...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для Каждого Запись Из ЭтотОбъект Цикл
		...
		Если Запись.РежимПротоколированияОбменаДанными и Запись.ИмяФайлаОбработкиДляОтладкиЗагрузки <> "" Тогда
			
			ПроверитьДоступностьФайлаПротоколаОбмена(Запись.ИмяФайлаОбработкиДляОтладкиЗагрузки, Отказ);
