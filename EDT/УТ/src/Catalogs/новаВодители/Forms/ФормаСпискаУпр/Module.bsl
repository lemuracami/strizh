...
Процедура УстановитьСотрудникиРоли()
	...
	Если Элементы.ФормаСотрудникиРоли.Пометка Тогда
		Заголовок = "Водители (Роль Водитель на " + Формат(ДатаРедактирования, "ДФ=dd.MM.yyyy") + ")";
		Список.Параметры.УстановитьЗначениеПараметра("СотрудникиРоли", Истина);
	Иначе
		Заголовок = "Водители (все роли)";
...
&НаКлиенте
Процедура ОтчетФизическиеЛицаЭкипажей(Команда)
	
	ОткрытьФорму("Отчет.ФизическиеЛицаЭкипажей.ФормаОбъекта");
