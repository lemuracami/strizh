...
Процедура ПередЗаписью(Отказ)
	...
	//	Сообщить("ИНН организации не может быть пустым!", СтатусСообщения.Важное);
	//	Отказ = Истина;
	//КонецеСли;	
	...
	Зап.УстановитьПараметр("ИНН", ИНН);
	Зап.УстановитьПараметр("Ссылка", Ссылка);
	Рез = Зап.Выполнить();
	Если Не Рез.Пустой() Тогда
		Сообщить("В справочнике Организации уже есть организация с данным ИНН!", СтатусСообщения.Важное);
		Отказ = Истина;
	КонецЕсли;	
