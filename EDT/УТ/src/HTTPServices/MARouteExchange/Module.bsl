...
Функция MARoutePOST(Запрос)
	...
	Попытка
		...
		ИначеЕсли ИмяМетода = "getTariffsAndBreakes" Тогда	
			...
			СтрокаJSON = РаботаСМобильнымПриложениемЭкипажейСервер.СформироватьСтрокуJSON(ОтветМетода);
			//Марочкин 01.11.2025<<<	
		ИначеЕсли ИмяМетода = "getCarPass" Тогда	
			ВходныеДанные = РаботаСМобильнымПриложениемЭкипажейСервер.ДанныеJSONВСтруктуру(ТекстЗапроса);
			ОтветМетода = РаботаСМобильнымПриложениемЭкипажейСервер.ПолучитьПарольТранспорта(ВходныеДанные);
			СтрокаJSON = РаботаСМобильнымПриложениемЭкипажейСервер.СформироватьСтрокуJSON(ОтветМетода);
			//Марочкин 04.11.2025<<<	
		ИначеЕсли ИмяМетода = "getOrdersByTripID" Тогда	
			ВходныеДанные = РаботаСМобильнымПриложениемЭкипажейСервер.ДанныеJSONВСтруктуру(ТекстЗапроса, "dateTrip");
			ОтветМетода = РаботаСМобильнымПриложениемЭкипажейСервер.ПолучитьЗаказыНаДоставку(ВходныеДанные);
			СтрокаJSON = РаботаСМобильнымПриложениемЭкипажейСервер.СформироватьСтрокуJSON(ОтветМетода);
			//Марочкин 09.11.2025<<<
		ИначеЕсли ИмяМетода = "getShops" Тогда	
			ВходныеДанные = РаботаСМобильнымПриложениемЭкипажейСервер.ДанныеJSONВСтруктуру(ТекстЗапроса);
			ОтветМетода = РаботаСМобильнымПриложениемЭкипажейСервер.ПолучитьИнтернетМагазины(ВходныеДанные);
			СтрокаJSON = РаботаСМобильнымПриложениемЭкипажейСервер.СформироватьСтрокуJSON(ОтветМетода);
			//Марочкин 09.11.2025<<<
		ИначеЕсли ИмяМетода = "setParameters" Тогда	
			ВходныеДанные = РаботаСМобильнымПриложениемЭкипажейСервер.ДанныеJSONВСтруктуру(ТекстЗапроса);
			ОтветМетода = РаботаСМобильнымПриложениемЭкипажейСервер.УстановитьПараметрыМП(ВходныеДанные);
			СтрокаJSON = РаботаСМобильнымПриложениемЭкипажейСервер.СформироватьСтрокуJSON(ОтветМетода);
			//Марочкин 10.11.2025<<<
		ИначеЕсли ИмяМетода = "getCausesDeliveryResults" Тогда	
			ВходныеДанные = РаботаСМобильнымПриложениемЭкипажейСервер.ДанныеJSONВСтруктуру(ТекстЗапроса);
			ОтветМетода = РаботаСМобильнымПриложениемЭкипажейСервер.ПолучитьПричиныОтказаПереноса(ВходныеДанные);
			СтрокаJSON = РаботаСМобильнымПриложениемЭкипажейСервер.СформироватьСтрокуJSON(ОтветМетода);
			//Марочкин 17.11.2025<<<
		ИначеЕсли ИмяМетода = "getPaymentTypes" Тогда	
			ВходныеДанные = РаботаСМобильнымПриложениемЭкипажейСервер.ДанныеJSONВСтруктуру(ТекстЗапроса);
			ОтветМетода = РаботаСМобильнымПриложениемЭкипажейСервер.ПолучитьСписокТиповОплат(ВходныеДанные);
			СтрокаJSON = РаботаСМобильнымПриложениемЭкипажейСервер.СформироватьСтрокуJSON(ОтветМетода);
			//Марочкин 20.11.2025<<<	
		ИначеЕсли ИмяМетода = "getCollectionOrdersByTripID" Тогда	
			ВходныеДанные = РаботаСМобильнымПриложениемЭкипажейСервер.ДанныеJSONВСтруктуру(ТекстЗапроса, "dateTrip");
			ОтветМетода = РаботаСМобильнымПриложениемЭкипажейСервер.ПолучитьЗаказыНаЗаборТовара(ВходныеДанные);
			СтрокаJSON = РаботаСМобильнымПриложениемЭкипажейСервер.СформироватьСтрокуJSON(ОтветМетода);
			//Марочкин 25.11.2025<<<
		ИначеЕсли ИмяМетода = "getLiftingData" Тогда	
			ВходныеДанные = РаботаСМобильнымПриложениемЭкипажейСервер.ДанныеJSONВСтруктуру(ТекстЗапроса);
			ОтветМетода = РаботаСМобильнымПриложениемЭкипажейСервер.ПолучитьДанныеИСтоимостьПодъема(ВходныеДанные);
			СтрокаJSON = РаботаСМобильнымПриложениемЭкипажейСервер.СформироватьСтрокуJSON(ОтветМетода);
			//Марочкин 27.11.2025<<<								
		КонецеСли;	
