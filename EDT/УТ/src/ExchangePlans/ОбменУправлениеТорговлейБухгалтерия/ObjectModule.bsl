...
Процедура ОпределитьТипОтправкиДанных(ЭлементДанных, ОтправкаЭлемента) Экспорт
	...
	Если мСоответствиеСкладовИУзлов = Неопределено Тогда
		...
		мСоответствиеСкладовИУзлов = ПроцедурыОбменаТорговляБухгалтерия.ПолучитьСоответствиеУзловИСкладов();
		
	КонецЕсли;
	
	Если мСоответствиеПодразделенийИУзлов = Неопределено Тогда
			
		мСоответствиеПодразделенийИУзлов = ПроцедурыОбменаТорговляБухгалтерия.ПолучитьСоответствиеУзловИПодразделений();
