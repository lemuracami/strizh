...
// Функция НайтиУзелПланаОбменаПоКоду
//
...
Функция ОбработкаОбменаДляЗагрузкиДанных(Отказ, УзелИнформационнойБазы, Знач ИмяФайлаСообщенияОбмена) Экспорт
	...
	ИмяПланаОбмена = ПолучитьИмяПланаОбмена(УзелИнформационнойБазы);
	НастройкиОтладки = ОбменДаннымиСервер.НастройкиРежимаОтладки(ИмяПланаОбмена);
	...
	Иначе;
		...
		ОбработкаОбменаДанными.ОтладкаОбработчиковЗагрузки = НастройкиОтладки.РежимОтладкиЗагрузки;
		ОбработкаОбменаДанными.ИмяФайлаВнешнейОбработкиОтладкиЗагрузки = НастройкиОтладки.ИмяФайлаОбработкиДляОтладкиЗагрузки;
...
// Функция АвтономнаяРаботаПоддерживается
//
...
Функция ПланыОбменаАвтономнойРаботы()
	...
	Для Каждого ПланОбмена Из Метаданные.ПланыОбмена Цикл
		...
		Если Не ОбменДаннымиСервер.ЭтоРазделенныйПланОбменаБСП(ПланОбмена.Имя) Тогда
			Продолжить;
		ИначеЕсли Не ПланОбмена.РаспределеннаяИнформационнаяБаза Тогда
			Продолжить;
		КонецЕсли;
...
Функция ЭтоАвтономноеРабочееМесто() Экспорт
	...
	Возврат АвтономнаяРаботаПоддерживается()
			...
			И ПланыОбмена.ГлавныйУзел().Метаданные().Имя = ПланОбменаАвтономнойРаботы()
	;
