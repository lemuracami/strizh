...
Функция ПолучитьАдресИзКонтактнойИнформации(Объект, ТипАдреса = "") Экспорт
	...
	ИначеЕсли ТипАдреса="Регистрации"
		...
		Начало = "Юр";
	ИначеЕсли ТипАдреса = "АдресТранспортнойКомпании" Тогда
		Начало = "АдресТранспортнойКомпании";
	Иначе
		Возврат "";
	КонецЕсли;
	...
	Если Начало <> "АдресТранспортнойКомпании" Тогда
		ВидАдреса = Справочники.ВидыКонтактнойИнформации[Начало+"Адрес"+Окончание].ПолучитьОбъект().Ссылка;
	Иначе
		ВидАдреса = Справочники.ВидыКонтактнойИнформации[Начало].ПолучитьОбъект().Ссылка;
	КонецеСли;	
