...
Функция ПолучитьТаблицуМаршрутовССайта(ИмяСервиса) Экспорт
	...
	Если Ответ.КодСостояния = 200 Тогда // Данные получены, обрабатываем их
		...
		ПолучитьТаблицуМаршрутовСервисовИзHTML(ТЗМаршрутов,ДокументПостроитель);
...
Процедура ЗаполнитьТЗМаршрутов(ТЗМаршрутов,ЭлементСтрокиТаблицы)
...
Процедура ПолучитьТаблицуМаршрутовСервисовИзHTML(ТЗМаршрутов,ДокументПостроитель)
...
Функция ПолучитьНастройки() Экспорт
	...
	Если НаборЗаписей.Количество() = 0 Тогда
		...
		Стр.APDEX_ОтключитьЗамер = Истина;
		//--- БАО 29.06.2017 №1208 
	КонецЕсли; 
