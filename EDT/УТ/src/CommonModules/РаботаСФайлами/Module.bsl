...
// Сохранить в файл из хранилища
//
Процедура СохранитьФайлИзХранилища(ИмяФайла, Хранилище, ИмяКаталога = Неопределено, ИмяСправочника = "ХранилищеДополнительнойИнформации") Экспорт
	...
	СохранитьФайл(СтруктураПараметров, ИмяФайла, Хранилище, СпособПерезаписи);
	Если (СпособПерезаписи <> Неопределено) И СтруктураПараметров.ОткрытьКаталог Тогда
