...
Процедура ВыполнитьОбновление() Экспорт
	...
	ВозможныеВерсииДляПерехода = """10.2.13"", ""10.3.1"", ""10.3.2"", ""10.3.3"", ""10.3.4"", ""10.3.5"", ""10.3.6"", ""10.3.7"", ""10.3.8"", ""10.3.9"", ""10.3.10"", ""10.3.11"", ""10.3.12"", ""10.3.13"", ""10.3.14"", ""10.3.15"", ""10.3.16"", ""10.3.17"", ""10.3.18"", ""10.3.19"", ""10.3.20""";
...
//////////////////////////////////////////////////////////////////////////
	...
	Если Найти("""10.3.2"", ""10.3.3"", ""10.3.5"", ""10.3.6"", ""10.3.7"", ""10.3.8"", ""10.3.9"", ""10.3.10"", ""10.3.11"", ""10.3.12"", ""10.3.13"", ""10.3.14"", ""10.3.15"", ""10.3.16"", ""10.3.17"", ""10.3.18"", ""10.3.19""", ТекущийНомерРелиза) <> 0 Тогда
		ТребуетсяЗапускПакетаОбработокОбновленияКонфигурации = Истина;
	КонецЕсли;
...
Процедура ЗаполнитьСправочникВидыКонтактнойИнформации()
	...
	Пока Выборка.Следующий() Цикл
		...
		//							
		//Иначе
			Если Выборка.Ссылка = Справочники.ВидыКонтактнойИнформации.АдресИнострОрганизацииУчред Тогда
