...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЕстьОшибки = КонфигурацияИзменена() И ПланыОбмена.ГлавныйУзел() = УзелИнформационнойБазы;
	
	// устанавливаем заголовок формы
	Заголовок = НСтр("ru = 'Обмен данными с ""%1""'");
	...
	РольДоступнаПолныеПрава = ПользователиБСП.РолиДоступны("ПолныеПрава");
	...
	Элементы.ТекстТребуетсяОбновлениеОрганиченныеПрава.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Элементы.ТекстТребуетсяОбновлениеОрганиченныеПрава.Заголовок, УзелИнформационнойБазы);
...
&НаКлиенте
Функция Подключаемый_ОжиданиеПроверкиПодключенияПарольЗадан_ОбработкаДлительнойОперации(Отказ, ПерейтиДалее)
...
Процедура ПроверитьПодключениеИСохранитьНастройки(Отказ)
	...
	Если Не ОбменДаннымиСервер.ЕстьПодключениеККорреспонденту(УзелИнформационнойБазы, ПараметрыПодключения, СообщениеПользователю) Тогда
...
&НаКлиенте
Функция Подключаемый_НачалоВыполненияОбмена_ПриОткрытии(Отказ, ПропуститьСтраницу, ЭтоПереходДалее)
...
Процедура СценарийОбменаЧерезВебСервис()
	...
	ТаблицаПереходовНоваяСтрока(1, "ОжиданиеПроверкиПодключенияПарольЗадан",,,,,, Истина, "ОжиданиеПроверкиПодключенияПарольЗадан_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(2, "ЗагрузкаДанных",,,,,, Истина, "ЗагрузкаДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(3, "ЗагрузкаДанных",,,,,, Истина, "ЗагрузкаДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(4, "ЗагрузкаДанных",,,,,, Истина, "ЗагрузкаДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(5, "ВыгрузкаДанных",,,,,, Истина, "ВыгрузкаДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(6, "ВыгрузкаДанных",,,,,, Истина, "ВыгрузкаДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(7, "ВыгрузкаДанных",,,,,, Истина, "ВыгрузкаДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
...
Процедура СценарийОбменаЧерезВебСервисСЗапросомПароля()
	...
	ТаблицаПереходовНоваяСтрока(2, "ОжиданиеПроверкиПодключения",,,,,, Истина, "ОжиданиеПроверкиПодключения_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(3, "ЗагрузкаДанных",,,,,, Истина, "ЗагрузкаДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(4, "ЗагрузкаДанных",,,,,, Истина, "ЗагрузкаДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(5, "ЗагрузкаДанных",,,,,, Истина, "ЗагрузкаДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(6, "ВыгрузкаДанных",,,,,, Истина, "ВыгрузкаДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(7, "ВыгрузкаДанных",,,,,, Истина, "ВыгрузкаДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(8, "ВыгрузкаДанных",,,,,, Истина, "ВыгрузкаДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
