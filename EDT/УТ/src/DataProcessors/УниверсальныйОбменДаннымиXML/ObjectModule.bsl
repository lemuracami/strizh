	...
	ИначеЕсли ФлагРежимОтладкиОбработчиков Тогда
		...
		Попытка
			...
			Иначе
				...
				ВнешняяОбработкаОбработчиковСобытий = ИмяФайлаВнешнейОбработкиОбработчиковСобытий;
...
Функция ЭтоВнешняяОбработка()
	...
	Если Лев(ИмяФайлаВнешнейОбработкиОбработчиковСобытий, 10) = "Обработка." Тогда
