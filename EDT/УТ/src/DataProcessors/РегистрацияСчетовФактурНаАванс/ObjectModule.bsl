			...
			Для Каждого СтрокаОтбораДоговор Из СтрокиПоДоговору Цикл
				...
				Иначе
					Если ТЧАвансыСтарые[СчФ] <> Неопределено Тогда
						...
						КонецЦикла;
						Если СуммаПоСтроке <> 0 Тогда
							СчФ.ДобавитьСтрокуАвансы(СчФ.Авансы, СтрокаОтбораДоговор.ДоговорКонтрагента.НаименованиеДляСчетаФактурыНаАванс, , СуммаПоСтроке, СуммаНДСПоСтроке, СтрокаОтбораДоговор.СтавкаНДС);
						КонецЕсли;
					Иначе
						СчФ.ДобавитьСтрокуАвансы(СчФ.Авансы, СтрокаОтбораДоговор.ДоговорКонтрагента.НаименованиеДляСчетаФактурыНаАванс, , СтрокаОтбораДоговор.Сумма, СтрокаОтбораДоговор.СуммаНДС, СтрокаОтбораДоговор.СтавкаНДС);
					КонецЕсли;					
				КонецЕсли;
