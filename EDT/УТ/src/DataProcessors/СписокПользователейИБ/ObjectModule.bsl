...
Процедура ДописатьСтрокуОтбора(СтрокаОтбора, ЭлементОтбора)
	...
	Если ЭлементОтбора.ВидСравнения = ВидСравнения.Равно Тогда
		СтрокаОтбора = СтрокаОтбора + ЭлементОтбора.Представление + " = "+ СокрЛП(ЭлементОтбора.Значение);
	...
	ИначеЕсли ЭлементОтбора.ВидСравнения = ВидСравнения.Содержит Тогда
		СтрокаОтбора = СтрокаОтбора + ЭлементОтбора.Представление + " содержит: "+ СокрЛП(ЭлементОтбора.Значение);
	КонецЕсли; 
...
//функция возвращает соответсвие имян и пользователей ИБ
