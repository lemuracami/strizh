...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ПредставлениеРазделенияДанныхСеанса") Тогда
		ПредставлениеРазделенияДанныхСеанса = Параметры.ПредставлениеРазделенияДанныхСеанса;
	КонецЕсли;
...
Процедура РазделениеДанныхСеансаОткрытие(Элемент, СтандартнаяОбработка)
	...
	ОткрытьЗначение(ПредставлениеРазделенияДанныхСеанса);
