...
Процедура ВыгрузитьДанные(Команда)
	...
	Сообщить("Начало - " + Формат(ТекущаяДата(), "ДЛФ=DDT"));
	АдресФайлаВоВременномХранилище = "";
	ВыгрузитьДанныеНаСервере(АдресФайлаВоВременномХранилище);
	Сообщить("Окончание - " + Формат(ТекущаяДата(), "ДЛФ=DDT"));	
...
Процедура ЗагрузитьДанные(Команда)
	...
	Если РежимРаботыНаКлиенте Тогда
		...
		НачатьПомещениеФайла(ОписаниеОповещения, АдресФайлаВоВременномХранилище,,Истина,УникальныйИдентификатор,);
