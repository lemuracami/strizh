...
Процедура СформироватьЗаказПоставщику(Выборка, Поставщик, ФормаПрогрессора, Форма)
...
Процедура ЗаказПоставщику(ПоОсновномуПоставщику = Ложь, Форма) Экспорт
	...
	Если ПоОсновномуПоставщику Тогда
		...
		Пока ВыборкаПоставщиков.Следующий() Цикл
			...
			СформироватьЗаказПоставщику(ВыборкаПоставщиков, ВыборкаПоставщиков.НоменклатураОсновнойПоставщик, ФормаПрогрессора, Форма);
	...
	Иначе
		...
		СформироватьЗаказПоставщику(РезультатЗапроса, Справочники.Контрагенты.ПустаяСсылка(), ФормаПрогрессора, Форма);
