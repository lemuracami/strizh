...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ДобавитьПолеГруппировка("НомерГТД", "СерияНоменклатуры", "НомерГТД", "Номер ГТД",, "ЕСТЬNULL(%ПолеВыборки%, ЗНАЧЕНИЕ(Справочник.НомераГТД.ПустаяСсылка))");
	УниверсальныйОтчет.ДобавитьПолеГруппировка("СтранаПроисхождения", "СерияНоменклатуры", "СтранаПроисхождения", "Страна происхождения",, "ЕСТЬNULL(%ПолеВыборки%, ЗНАЧЕНИЕ(Справочник.КлассификаторСтранМира.ПустаяСсылка))");
	...
	УниверсальныйОтчет.ДобавитьИзмерениеСтроки("НомерГТД");
