...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	|ВЫБРАТЬ
	|	БанковскийСчетКасса,
	|	ТекущийОстаток_ВВалютеДенСредств,
	|	ТекущийОстаток_Оборот,
	|	СуммаКСписанию_ВВалютеДенСредств,
	|	СуммаКСписанию_Оборот,
	|	СуммаКПолучению_ВВалютеДенСредств,
	|	СуммаКПолучению_Оборот,
	|	СуммаВРезерве_ВВалютеДенСредств,
	|	СуммаВРезерве_Оборот
	|{
	|ВЫБРАТЬ
	|	Период,
	|	БанковскийСчетКасса}
