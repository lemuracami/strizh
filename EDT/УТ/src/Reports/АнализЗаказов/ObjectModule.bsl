...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ИмяРегистра = "ЗакрытыеЗаказы";
	...
	УниверсальныйОтчет.ДобавитьИзмерениеСтроки("ТипЗаказа");
	УниверсальныйОтчет.ДобавитьИзмерениеСтроки("ИнтернетМагазин");
	...
	УниверсальныйОтчет.ДобавитьОтбор("ТипЗаказа");
	УниверсальныйОтчет.ДобавитьОтбор("ИнтернетМагазин");
	УниверсальныйОтчет.ДобавитьОтбор("ТипОплаты");
	УниверсальныйОтчет.ДобавитьОтбор("СтатусЗаказа");
	УниверсальныйОтчет.ДобавитьОтбор("СтатусИнтернетМагазина");
	УниверсальныйОтчет.ДобавитьОтбор("ПричинаНеВыполнения");
