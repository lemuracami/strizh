...
Процедура УстановитьНачальныеНастройкиУпр(ДополнительныеПараметры = Неопределено)
	...
	|	ИсточникДанных.СкладскоеПомещение КАК СкладскоеПомещение,
	|	ПРЕДСТАВЛЕНИЕ(ИсточникДанных.СкладскоеПомещение),	
	...
	|	Склад.* КАК Склад,
	|	СкладскоеПомещение.* КАК СкладскоеПомещение,	
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СкладскоеПомещение", "Складское помещение");
	...
	УниверсальныйОтчет.ДобавитьОтбор("СкладскоеПомещение");
